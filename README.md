Tasmota with some very rudimentary WS2801 static color support using [WS2801FX](https://github.com/r41d/WS2801FX).
First test with familiar libraries, blinking still needs to be added...
